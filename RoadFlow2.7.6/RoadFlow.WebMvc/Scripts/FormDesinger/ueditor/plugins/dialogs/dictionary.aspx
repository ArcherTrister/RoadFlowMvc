...
<script type="text/javascript">
    ...
    $(function ()
    {
        ...
        {
            $text = $(oNode);
            $("#defaultvalue").val(decodeURI($text.attr('defaultvalue')));
            ...
            $("#ds_table_where").val(RoadUI.Core.decodeUri($text.attr("ds_table_where") || ""));
    ...
    dialog.onok = function ()
    {
        ...
        html += 'ds_table_where="' + encodeURIComponent(ds_table_where) + '" ';
        html += '/>';
        if (oNode)
        {
            $(oNode).after(html);
